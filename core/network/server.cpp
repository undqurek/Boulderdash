...
//        this->_acceptanceTimeout.tv_sec = 0;
//        this->_acceptanceTimeout.tv_usec = 500;
...
//    uint32_t Server::getAcceptanceTimeout()
//    {
//        return (uint32_t)this->_acceptanceTimeout.tv_usec;
//    }

//    void Server::setAcceptanceTimeout(uint32_t microseconds)
//    {
//        this->_acceptanceTimeout.tv_usec = (uint32_t)microseconds;
//    }
